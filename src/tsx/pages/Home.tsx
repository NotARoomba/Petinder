  ...
  return (
    <div className="dark:bg-gunmetal-300 dark:text-gunmetal-900 text-gunmetal h-full pt-12 mb-auto">
      <div className="justify-center text-center">
        <p className="text-6xl sm:text-8xl font-bold bg-gradient-to-t from-hot_pink-300 via-persian_pink to-tickle_me_pink text-transparent bg-clip-text mb-2">Petinder</p>
      ...
      <div className="h-full pb-32">
        <div className="flex flex-col justify-center mx-auto md:justify-start md:flex-row items-center mt-24">
          <img src="/img/family-dog.jpg" className=" w-2/5 min-w-[300px] md:min-w-[325px] rounded-xl mx-16 border-hot_pink bo" />
        ...
        <div className="justify-end flex md:flex-row flex-col-reverse items-center mt-24">
          ...
          <img src="/img/dog-smiling.jpg" className=" w-2/5 min-w-[300px] md:min-w-[325px] rounded-xl mx-16 border-hot_pink" />
        </div>
      </div>
    </div>
  );
