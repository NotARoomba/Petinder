  ...
  return (
    <div className="flex w-screen shadow-lg h-20 dark:bg-gunmetal-300">
      ...
      <div className="flex w-1/2 justify-end items-center">
        ...
        <div
          className="flex xl:hidden group items-center flex-col w-16 aspect-square py-3 hover:bg-gunmetal-900 dark:hover:bg-gunmetal-500 rounded-lg mr-2 p-1 my-auto align-middle cursor-pointer transition-all "
        ...
        >
          ...
          <span
            className={
              ...
              (menu ? " bg-transparent " : " bg-gunmetal dark:bg-gunmetal-900")
            }
          ></span>
          <span
            className={
