...
export default function ThemeButton({ theme, changeTheme }: ThemeButtonProps) {
  return (
    <button
      type="button"
      className="aspect-square h-16 xl:flex  text-gunmetal-500 dark:text-gunmetal-900 hover:bg-gunmetal-900 dark:hover:bg-gunmetal-500  rounded-lg text-md justify-center align-middle mr-2"
      onClick={changeTheme}
    >
      {theme === "light" ? (
        <svg
