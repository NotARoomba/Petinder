...
export default function Card({image, name, description}: CardProps) {
    return <div className=" inline-block rounded-xl shadow-xl min-w-[16rem] max-w-[24rem] align-top py-px mb-16 h-fit mx-5 text-center text-gunmetal justify-center dark:bg-gunmetal-400">
